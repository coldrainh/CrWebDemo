...
import core.ui.imp.ActionDbClick;
...
public class DataTree extends JTree {
    ...
    public void setActionDbclick(ActionDbClick actionDblClick) {
    ...
    private class RightClickEvent extends MouseAdapter {
        ...
        private ActionDbClick actionDblClick;
        ...
        public ActionDbClick getActionDblClick() {
            return this.actionDblClick;
        }

        public void setActionDblClick(ActionDbClick actionDblClick) {

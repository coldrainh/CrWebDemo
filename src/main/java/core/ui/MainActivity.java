...
public class MainActivity {
    ...
    private void initVariable() {
        ...
        //this.frame.setDefaultLookAndFeelDecorated(true);    //设置圆角
        this.frame.setTitle("CrWebmaster");
    ...
    private void aboutMenuItemClick(ActionEvent e) {
        JOptionPane.showMessageDialog(getFrame(), "基于流量加密的webshell管理工具", "About", JOptionPane.PLAIN_MESSAGE);
